...
feature_imp_LR.to_csv('/linux_home/gepostill/Files/u/gepostill/EXPORT/Task2_Coefficients_LR.csv')


#Plot the importances - using testing data
plt.figure(figsize=(8,6))
sns.barplot(x='Absolute Coefficient', y='Feature', data=feature_imp_LR)
plt.title('Feature Importances from Logistic Regression (Task 2) - Coefficients')
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.tight_layout()
plt.savefig('/linux_home/gepostill/Files/u/gepostill/EXPORT/Task2_Feature_imp_LR_coefficient.png', dpi=700)
plt.show()
...
plt.title('Feature Importances from Random Forest (Task 2) - Gini Impurity')
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.tight_layout()
...
################# AUROC Task 2 -- Plotting all Models  #################
...
def auc_model3(model1, model2, model3, X_train, y_train, X_test, y_test, plot_name):
    ...
    print(f"LR2 AUC on Training Data: {auc_train_model1}")
    ...
    print(f"LR2 AUC on Testing Data: {auc_test_model1}")
    ...
    print(f"RF2 AUC on Training Data: {auc_train_model2}")
    ...
    print(f"RF2 AUC on Testing Data: {auc_test_model2}")
    ...
    print(f"XGB2 AUC on Training Data: {auc_train_model3}")
    ...
    print(f"XGB2 AUC on Testing Data: {auc_test_model3}")

    # Ploting ROC Curve
    plt.figure(figsize=(8, 8))
    plt.plot(fpr_train_model1, tpr_train_model1, color='darkgray', lw=2, label=f'LR2: Training ROC (AUC = {auc_train_model1:.2f})')
    plt.plot(fpr_test_model1, tpr_test_model1, color='darkgray', lw=2, linestyle='--', label=f'LR2: Testing ROC (AUC = {auc_test_model1:.2f})')
    plt.plot(fpr_train_model2, tpr_train_model2, color='dodgerblue', lw=2, label=f'RF2: Training ROC (AUC = {auc_train_model2:.2f})')
    plt.plot(fpr_test_model2, tpr_test_model2, color='dodgerblue', lw=2, linestyle='--', label=f'RF2: Testing ROC (AUC = {auc_test_model2:.2f})')
    plt.plot(fpr_train_model3, tpr_train_model3, color='navy', lw=2, label=f'XGB2: Training ROC (AUC = {auc_train_model3:.2f})')
    plt.plot(fpr_test_model3, tpr_test_model3, color='navy', lw=2, linestyle='--', label=f'XGB2: Testing ROC (AUC = {auc_test_model3:.2f})')
...
################# SHAP Plots for the Models in Task 2  #################

#SHAP ANALYSIS
#Note on the SHAP analysis - the features that are still sclaed. This should not affect 
...
plt.savefig('/linux_home/gepostill/Files/u/gepostill/EXPORT/Task2_LR_shap_summary_plot.png')
plt.show()
