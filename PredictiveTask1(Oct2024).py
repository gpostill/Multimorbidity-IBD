...
acc_train_LR, acc_test_LR = auc_model(retrained_LR_model, X_train, y_train, X_test, y_test, 
                                      FILE_NAME)
...
#Accuracy + AUC plot with the new retrained model
acc_train_RF, acc_test_RF = auc_model(retrained_RF, X_train, y_train, X_test, y_test, 
                                     FILE_NAME)
...
df_tree.to_csv(FILE)NAME, index=False)
...
#Accuracy + AUC plot with the new retrained model
acc_train_XGB, acc_test_XGB = auc_model(retrained_XGB, X_train, y_train, X_test, y_test, 
                                      FILE_NAME)
